                    ...
                    <table class="table table-striped table-bordered table-hover" id="tabelsurat" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            foreach ($surat as $suratdata) {
                                ...
                                <td>
                                <div>
                                <a href=" . base_url('admin/surat_masuk/getedit/' . $suratdata->id) .
                                    " class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</a>
                                <a href=" . base_url('admin/surat_masuk/delete/' . $suratdata->id) .
                                    " class='btn btn-sm btn-danger'onclick='return confirm(\"Ingin mengapus data user ini?\");'>
